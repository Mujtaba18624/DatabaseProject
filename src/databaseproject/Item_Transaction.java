...
public class Item_Transaction extends javax.swing.JFrame {
    ...
    public Item_Transaction() {
        initComponents();
         //jTable1.getTableHeader().setDefaultRenderer((TableCellRenderer) new Item_Transaction());
    ...
    private void initComponents() {
        ...
        BackgroundPanel.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 320, -1, -1));
        ...
        BackgroundPanel.add(cardNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 320, 210, 30));
        ...
        cardName.setFont(new java.awt.Font("Nirmala UI", 0, 18)); // NOI18N
        cardName.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        cardName.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cardNameActionPerformed(evt);
            }
        });
        BackgroundPanel.add(cardName, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 420, 210, 30));
