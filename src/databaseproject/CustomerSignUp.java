...
//            }
    ...
    private void initComponents() {
        ...
        BackgroundPanel.add(password, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 380, 420, 50));
        ...
        password1.setFont(new java.awt.Font("Nirmala UI", 0, 30)); // NOI18N
        ...
        BackgroundPanel.add(password1, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 270, 420, 50));
    ...
    private void SignUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SignUpActionPerformed
        ...
        if(!password.getText().equals(password1.getText())){
             JOptionPane.showMessageDialog(f, "Passwords should match. Please try again.", "ERROR", JOptionPane.ERROR_MESSAGE);
        }else{
        SignUp_Method();
